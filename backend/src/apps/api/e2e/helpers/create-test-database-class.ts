...
export class CreateTestDatabaseHelper {
	...
	private createTestSchemaName = () =>
		CreateTestDatabaseHelper.testSchemaPrefixName + randomUUID();

	private setSchemaSearchParamToUrl(baseDbUrl: string, schemaName: string) {
